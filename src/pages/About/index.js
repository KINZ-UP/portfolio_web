...
import MetaFlowImg from "../../assets/metaflow.png";
...
const About = () => (
  <StyledAbout>
    <div className="img-container">
      <img src={MetaFlowImg} alt="background" />
    </div>
    <PageContainer>
      ...
      <section className="introduction">
        ...
        <div className="sub-section">
          ...
          <ul className="sub-section-content">
            ...
            <li>항상 가독성과 확장성을 중시한 코드를 짜기 위해 노력합니다.</li>
        ...
        <div className="sub-section">
          ...
          <ul className="sub-section-content">
            ...
            <li>
              <b>Blog</b> |{" "}
              <a href="https://kinz-up.github.io">https://kinz-up.github.io</a>
            </li>
          </ul>
        </div>
      </section>
